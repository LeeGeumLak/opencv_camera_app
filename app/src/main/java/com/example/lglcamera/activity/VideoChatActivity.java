...
import com.example.lglcamera.adapter.ChatAdapter;
import com.example.lglcamera.data.ChatMessage;
import com.example.lglcamera.server.XirSysRequest;
import com.example.lglcamera.utils.Constants;
import com.example.lglcamera.utils.LogRTCListener;
...
public class VideoChatActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.chatEditText = (EditText) findViewById(R.id.chat_input);
        ...
        chatAdapter = new ChatAdapter(this, ll);
